    ...
    CarRender._carsShow = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        carDiv = document.querySelector('#carsDiv');
                        carDiv.innerText = '';
                    ...
                    case 1:
                        ...
                        cars.forEach(function (car) {
                            ...
                            itemDiv.innerText = "".concat(id, " ").concat(brand, " -- ").concat(price, " -- ").concat(year);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, carService.create({ brand: brand, price: +price, year: +year })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this._carsShow()];
                    case 2:
